                        ...
                        <div className="detail-r">
                            <div className="tuser-info">
                                ...
                                <div className="tuser-id">
                                    <h3>
                                        <Link to={`/user/${this.state.all.trade.tuser.userNo}`}>
                                            {this.state.all.trade.tuser.nickname}
                                        </Link>
                                    </h3>
                            ...
                            <div className="trade">
                                <h4>
                                    카테고리 >{" "}
                                    {this.category[Number(this.state.all.trade.tradeCategory)].name}
                                </h4>
                                ...
                                <div className="bottom">
                                    <button className="btn-heart">
                                        <Zzim
                                            ...
                                            uno={this.state.all.trade.tuser.userNo}
                                        ></Zzim>
                                    </button>
