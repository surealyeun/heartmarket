    ...
    return (
      <>
        ...
        <div key={this.state.data.mailNo} className="DetailAlarm">
          ...
          {/* 거래에 대한 정보 표시 */}
          {this.state.data.trade.tradeNo !== 0 && (
            <Link
              to={{
            ...
            >
              <div className="trade_div">
                <img className="trade_img" alt="profile" src={this.state.data.trade.ttradeImg[0].orgImg}></img>
                <p className="mainTitle">{this.state.data.trade.tradeTitle}</p>
                <div className="subTitle">{this.state.data.trade.productInfo}</div>
              </div>
            </Link>
          )}
          ...
          <div className="btn">
            ...
            <Modal tradeNo={this.state.data.trade.tradeNo} email={Memail} nickname={Mnickname} isOpen={this.state.isModalOpen} close={this.closeModal} />
            <br></br>
          </div>
        </div>
        <Footer></Footer>
