  ...
  render() {
    ...
    return (
      <>
        ...
        <div className="Write">
          <div>
            <input className="write_address" value={this.user.uarea[0].address} type="text" readOnly></input>
            <select value={this.state.category} className="write_category" name="category" onChange={e => this.InputChange(e)}>
            ...
            <input className="write_input" name="title" type="text" placeholder="글 제목을 입력해주세요." onChange={e => this.InputChange(e)} required></input>
            <input className="write_input" name="price" type="number" min="0" max="9999999999" placeholder="가격을 입력해주세요." onChange={e => this.InputChange(e)} required></input>
            <textarea className="textarea" name="explain" placeholder="상품 설명을 입력해주세요" onChange={e => this.InputChange(e)} required></textarea>
            <div className="filebox">
              <label>
                제품 사진 업로드
                <input key={this.state.filekey} className="write_input" multiple id="ex_file" type="file" name="images" onChange={e => this.InputChange(e)} />
              </label>
              <div className="write_filenum">{this.state.images.length}개의 사진이 업로드 되었습니다.</div>
            </div>
