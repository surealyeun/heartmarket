    ...
    return (
      <div className="AlarmList" key={this.state.data.mailNo}>
        <div className="alarm_item">
          {this.state.data.readDate === null ? <div className="btn new_btn">new</div> : <div className="btn read_btn">Read</div>}

          <div className="time">{this.state.data.sendDate.substring(2, 16)}</div>
          <Link
            to={{
