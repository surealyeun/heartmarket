    ...
    return (
      <div className="big">
        ...
        <div className="join-detail">
          ...
          <br />
          <form>
            <input type="text" className="nickname" placeholder="닉네임 최대 8글자" onChange={this.nicknameValid} required /> <br />
            <input type="email" className="email" value={this.state.email} placeholder="email" disabled />
            <br />
            <input type="password" className="password" placeholder="비밀번호" required onChange={e => this.handlePW(e.target.value)} />
            <br />
            {/* <input
                            type="text"
                            className="address"
            ...
            <br />
            <Link to="/joinsuc">
              <button type="button" className="btn-joinpage" /*disabled={!this.state.confirm}*/ onClick={this.handleOnClick}>
                회원가입
              </button>
            </Link>
            <Link to="/">
