      ...
      <>
        ...
        <div className="Write WriteUpdate">
          <div>
            ...
            <input className="write_input" name="title" type="text" value={this.state.title} placeholder="글 제목을 입력해주세요." onChange={e => this.InputChange(e)} required></input>
            <input
              ...
              required
            ></input>
            <textarea className="textarea" name="explain" value={this.state.explain} placeholder="상품 설명을 입력해주세요" onChange={e => this.InputChange(e)} required></textarea>
